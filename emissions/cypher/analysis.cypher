//Summary of emissions / gdp by country (Australia) between 2000 and 2010
...
// Avg emissions and GDP for countries in continent (Insular Oceania)
...
// Analysis of neighbouring countries (sharing border) with selected one (Iran)
